    ...
    <div class="mian-content" id="portfolio">
        <section class="pe-container">
            <ul id="pe-thumbs" class="pe-thumbs">
                <li>
                    <a href="<?php echo Yii::app()->baseUrl.'/mscompany/view/'.$companys[0]->id?>">
                        <img src="<?php echo Yii::app()->baseUrl.'/'.$companys[0]->logo?>" />
                        <div class="pe-description">
                            <h3><?php echo $companys[0]->name?></h3>
                            <p><?php echo $companys[0]->website?></p>
                        </div>
                    </a>
                </li>
                ...
                <li><a href="#"><img src="<?php echo Yii::app()->baseUrl.CSS_PATH?>/images/thumbs/23.jpg" /><div class="pe-description"><h3>constant temper</h3><p>His constant temper, in the equal weight</p></div></a></li>
                <li><a href="#"><img src="<?php echo Yii::app()->baseUrl.CSS_PATH?>/images/thumbs/24.jpg" /><div class="pe-description"><h3>thankfulness</h3><p>Of thankfulness and kindness: Truth doth leave</p></div></a></li>
                <li><a href="#"><img src="<?php echo Yii::app()->baseUrl.CSS_PATH?>/images/thumbs/25.jpg" /><div class="pe-description"><h3>proof</h3><p>Sufficient proof, he was in every right</p></div></a></li>
                <li><a href="#"><img src="<?php echo Yii::app()->baseUrl.CSS_PATH?>/images/thumbs/26.jpg" /><div class="pe-description"><h3>thankful</h3><p>As kind to give, as thankful to receive.</p></div></a></li>
                <li><a href="#"><img src="<?php echo Yii::app()->baseUrl.CSS_PATH?>/images/thumbs/27.jpg" /><div class="pe-description"><h3>curious eye</h3><p>The curious eye of a quick-brained survey</p></div></a></li>
            </ul>
        </section>
    <!--<div class="header">-->
    <!--    <div class="row">-->
